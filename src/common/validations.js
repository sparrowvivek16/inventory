...
function registerVendorValidation(values) {
    if (!values.name) {
        alerts.error('Name is required.');
    }
    else if (!values.company) {
    ...
    else if (!values.accNumber) {
        alerts.error('Acc Number is required.');
    }
    else if (isNaN(values.accNumber)) {
        alerts.error('Enter Number.');
    }
    else if (!values.ifscCode) {
        alerts.error('IFSC Number is required.');
    }
    else if (isNaN(values.ifscCode)) {
        alerts.error('Enter Number.');
    }
    else if (!values.accHolder) {
        alerts.error("Acc Holder is required.");
    }
    else if (!values.remarks) {
        alerts.error("Remarks is required.");
    }
